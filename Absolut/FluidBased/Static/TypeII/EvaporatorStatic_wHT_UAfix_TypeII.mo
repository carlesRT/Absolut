...
model EvaporatorStatic_wHT_UAfix_TypeII
  "Evaporator with heat Transfer"
...
equation
  // Mass balance
  port_l_a.m_flow +port_v.m_flow  = 0;
  ...
  Hb_flow =   (port_l_a.m_flow*actualStream(port_l_a.h_outflow)) + port_v.m_flow *actualStream(port_v.h_outflow);
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
    ...
    Documentation(info="<html></html>"),
              Icon(graphics={
        Line(points={{136,-64},{136,-44},{116,-36},{122,-66},{146,-60},{-84,14},
              {-52,12},{-100,88},{-84,92},{-92,88},{-86,82}}, color={28,108,200}),
        Line(points={{-98,84},{-92,88}}, color={28,108,200}),
        Line(points={{-92,96},{-120,78}}, color={28,108,200}),
        Line(points={{-100,82},{-88,92}}, color={0,0,0}),
        Line(
          points={{-100,92},{-90,88},{-104,78}},
          color={0,0,0},
        ...
        Rectangle(
          ...
          fillColor={0,128,255},
          fillPattern=FillPattern.Solid)}));
end EvaporatorStatic_wHT_UAfix_TypeII;
