...
equation
  // Mass balance
  X_H2O = 1 - X_LiBr;
  port_v.m_flow + port_l_b.m_flow + port_l_a.m_flow + port_l_high.m_flow + port_v_high.m_flow = 0;

  mXi_flow_l = port_l_a.m_flow * inStream(port_l_a.Xi_outflow) + port_l_high.m_flow * inStream(port_l_high.Xi_outflow);
  ...
  port_v_high.h_outflow = Medium_v.specificEnthalpy(Medium_v.setState_pTX(p, T1and2, {1}));
  ...
  Hb_flow = port_l_b.m_flow*actualStream(port_l_b.h_outflow) + port_v.m_flow*actualStream(port_v.h_outflow) + port_l_a.m_flow*actualStream(port_l_a.h_outflow) + port_l_high.m_flow*actualStream(port_l_high.h_outflow) + port_v_high.m_flow*actualStream(port_v_high.h_outflow);
