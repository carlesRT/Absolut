...
model AHP_pump_hex_extended
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe_con(
    ...
    redeclare model FlowModel =
        Modelica.Fluid.Pipes.BaseClasses.FlowModels.NominalLaminarFlow (
          dp_nominal(displayUnit="bar") = 20000, m_flow_nominal=0.1),
    p_a_start=400000,
  ...
  Modelica.Fluid.Pipes.DynamicPipe pipe_gen(
    ...
    redeclare model FlowModel =
        Modelica.Fluid.Pipes.BaseClasses.FlowModels.NominalLaminarFlow (
          dp_nominal(displayUnit="Pa") = 20000, m_flow_nominal=0.1),
 ...
 parameter Modelica.Units.SI.ThermalConductance UA_amb=0
  ...
  Static.Components.HEX.simpleHX hex_abs(
    ...
    dp2_nominal=0,
    configuration=Buildings.Fluid.Types.HeatExchangerConfiguration.CounterFlow,
    UA_fix(displayUnit="W/K") = UA_fix_abs) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={178,-92})));
  ...
  Static.Components.HEX.simpleHX hex_gen(
    ...
    dp2_nominal=0,
    configuration=Buildings.Fluid.Types.HeatExchangerConfiguration.CounterFlow,
    UA_fix(displayUnit="W/K") = UA_fix_gen) annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={46,142})));
  ...
  Modelica.Blocks.Sources.RealExpression UAabs(y=(max(0.1, (port_abs_a.m_flow/
    ...
    annotation (Placement(transformation(extent={{-4,-230},{16,-210}})));
  ...
  Modelica.Blocks.Sources.RealExpression UAcon(y=(max(0.1, (port_con_a.m_flow/(
    ...
    annotation (Placement(transformation(extent={{-316,166},{-296,186}})));
  ...
  Modelica.Blocks.Routing.Replicator replicator_eva(nout=nEle)
    annotation (Placement(transformation(extent={{-142,-162},{-162,-142}})));
...
equation
  ...
  connect(pump_abstogen.port_l_b, simpleHX.port_a1)
  ...
  connect(con.port_v,gen. port_v) annotation (Line(points={{-166,96},{-168,96},
          {-168,116},{72,116},{72,104},{90,104}},
                             color={0,127,255}));
  connect(pipe_abs.port_a, port_abs_a) annotation (Line(points={{188,-184},{206,
  ...
  connect(pipe_con.port_a, port_con_a)
    annotation (Line(points={{-188,210},{-150,210}}, color={0,127,255}));
  connect(port_con_b, pipe_con.port_b)
    annotation (Line(points={{-230,210},{-208,210}}, color={0,127,255}));
  ...
  connect(pipe_eva.port_a, port_eva_a) annotation (Line(points={{-202,-186},{
          -186,-186},{-186,-190},{-170,-190}},
                                          color={0,127,255}));
  connect(pipe_abs.port_b, hex_abs.port_a1) annotation (Line(points={{168,-184},
  ...
  connect(hex_abs.port_b2, abs.port_l_a) annotation (Line(points={{184,-102},{
        ...
        color={0,127,255}));
  connect(hex_gen.port_a2, simpleHX.port_b1) annotation (Line(points={{52,132},{
          52,40},{30,40},{30,-6}}, color={0,127,255}));
  ...
  connect(simpleHX.port_b2, flashingLiBr.port_a) annotation (Line(points={{42,-26},
  ...
  connect(pipe_con.heatPorts, convection2.fluid) annotation (Line(points={{-198.1,
          214.4},{-198.1,228},{-232,228},{-232,176},{-192,176},{-192,170},{-182,
          170}},                                  color={127,0,0}));
  ...
  connect(simpleHX.port_a2, pump_gentoabs.port_l_b) annotation (Line(points={{42,
          -6},{40,-6},{40,8},{86,8},{86,35},{88,35}}, color={0,127,255}));
  ...
  connect(convection4.Gc, replicator_eva.y) annotation (Line(points={{-186,-150},
          {-174,-150},{-174,-152},{-163,-152}}, color={0,0,127}));
  connect(convection6.Gc, replicator_gen.y) annotation (Line(points={{206,182},{
          208,182},{208,214},{239,214}}, color={0,0,127}));
  connect(convection7.Gc, replicator_gen.y) annotation (Line(points={{148,186},{
          148,192},{218,192},{218,216},{239,216},{239,214}}, color={0,0,127}));
  connect(convection5.Gc, replicator_eva.y) annotation (Line(points={{-184,-96},
          {-178,-96},{-178,-152},{-163,-152}}, color={0,0,127}));
  connect(pipe_abs.heatPorts, convection1.fluid) annotation (Line(points={{177.9,
          -188.4},{177.9,-210},{200,-210},{200,-170},{226,-170},{226,-144},{220,
          -144}},      color={127,0,0}));
  connect(replicator_gen.u, UAgen.y) annotation (Line(points={{262,214},{268,214},
          {268,164},{287,164}}, color={0,0,127}));
  connect(replicator_eva.u, UAeva.y) annotation (Line(points={{-140,-152},{-121,
          -152},{-121,-142}}, color={0,0,127}));
  connect(UAcon.y, replicatorcon.u) annotation (Line(points={{-295,176},{-286,176},
          {-286,174},{-262,174},{-262,170}}, color={0,0,127}));
  connect(UAabs.y, replicator_abs.u) annotation (Line(points={{17,-220},{92,-220},
          {92,-224},{100,-224}}, color={0,0,127}));
