...
function specificGibbsEnergy_TXp_derp
  ...
  output Real gderp "Specific gibbs energy of the solution";
protected
  ...
  Real[5] X = {1,X_LiBr*100,(X_LiBr*100)^2,(X_LiBr*100)^3,(X_LiBr*100)^1.1};

algorithm
  gderp:= 1000*(V[1] + V[2]*X[2] + V[3]*X[3] + V[4]*T + V[5]*X[2]*T + V[6]*X[3]*T + V[7]*T^2 + V[8]*X[2]*T^2);
  annotation(smoothOrder = 10, derivative = Absolut.Media.LiBrH2O.specificGibbsEnergy_TXp_derp_der);
end specificGibbsEnergy_TXp_derp;
