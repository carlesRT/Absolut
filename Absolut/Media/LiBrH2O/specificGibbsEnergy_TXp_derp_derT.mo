...
function specificGibbsEnergy_TXp_derp_derT
  ...
  output Real gderpderT(unit="J/(kg.Pa)") "Specific gibbs energy of the solution";
protected
...
algorithm
  gderpderT:= 1000*(V[4] + V[5]*X[2] + V[6]*X[3] + 2*V[7]*T + 2*V[8]*X[2]*T);
  annotation(smoothOrder = 10);
end specificGibbsEnergy_TXp_derp_derT;
