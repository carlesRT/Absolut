...
function specificHeatCapacity_SSC_TXp_derT
  ...
  output Real cpderT "Specific heat capacity of the solution";
protected
...
algorithm
  cpderT := 1000*(-2*C*X - 12*T*D*X - 36*(T^2)*E*{1,X[2]} + 2*F*{1,X[2]}*(2*T+T0)/(T-T0)^4 - 2*pkPa*{V[7],V[8]}*{1,X[2]} - (1/T^2)*L*X);

end specificHeatCapacity_SSC_TXp_derT;
