...
function specificGibbsEnergy_TXp_derX_derp
  ...
  output Real gderXderp "Derivative respect to X_H2O of the specific gibbs energy";
protected
...
algorithm
  gderXderp:= 1000*(V[2] + V[3]*X[3] + V[5]*T + V[6]*X[3]*T + V[8]*T^2);
annotation(smoothOrder = 10);
end specificGibbsEnergy_TXp_derX_derp;
