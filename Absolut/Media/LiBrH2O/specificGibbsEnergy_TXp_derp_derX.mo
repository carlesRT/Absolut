...
function specificGibbsEnergy_TXp_derp_derX
  ...
  output Real gderpderX(unit="J/(kg.Pa)") "Specific gibbs energy of the solution";
protected
...
algorithm
  gderpderX:= 1000*(V[2] + 2*V[3]*X[2] + V[5]*T +2*V[6]*X[2]*T + V[8]*T^2);
  annotation(smoothOrder = 10);
end specificGibbsEnergy_TXp_derp_derX;
