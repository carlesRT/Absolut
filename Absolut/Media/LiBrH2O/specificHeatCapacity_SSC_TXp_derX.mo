...
function specificHeatCapacity_SSC_TXp_derX
  ...
  output Real cpderx "Specific heat capacity of the solution";
protected
...
algorithm
  cpderx := 1000*(-2*T*C*X - 6*(T^2)*D*X - 12*(T^3)*E*{0,1} - 2*F*{0,1}*T/(T-T0)^3 - 2*pkPa*T*V[8] + (1/T)*L*X - M*X);

end specificHeatCapacity_SSC_TXp_derX;
