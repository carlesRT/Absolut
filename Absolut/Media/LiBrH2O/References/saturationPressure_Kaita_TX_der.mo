...
function saturationPressure_Kaita_TX_der "Vapour pressure of the H2O/LiBr solution as a function of T and X_LiBr.
Based on Uemura and Hasaba"
  ...
  output Real der_p_v "vapour pressure of the solution in the vessel";
...
der_p_v :=1000*(log10(10)*(10^(k[1] + k[2]/(TD) +k[3]/(TD^2)))*(-(k[2]/TD^2)-(2*k[3]/TD^3)))*dewPoint_Kaita_TX_der(T,X_H2O,der_T,der_X_H2O);

annotation(derivative=Absolut.Media.LiBrH2O.References.saturationPressure_Kaita_TX_der_der);
end saturationPressure_Kaita_TX_der;
